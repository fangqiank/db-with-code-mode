...
The baseline set for a project using `@tanstack/ai-code-mode` + `@netlify/database`:
...
Add a package to `serverExternal` + `dependencies` whenever you see one of the errors in Troubleshooting below.
