...
> Prerequisite: this skill assumes code mode is already set up. See `ai-code-mode` for the base setup (drivers, `createCodeMode`, API route, client wiring).
